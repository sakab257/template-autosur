...
const steps = [
  ...
  },
  {
    ...
    description: "Repartez l'esprit libre avec un véhicule sûr, en règle et validé pour 2 ans. Bonne route !",
    icon: ShieldCheck,
    isFinished: true,
  },
];
...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="relative bg-white py-24 lg:pt-32 lg:pb-40">
      {/* --- HEADER MOBILE --- */}
                            ...
                            `}>
                                ...
                                <div className="relative z-10">
                                    ...
                                    {step.isAction ? (
                                      ...
                                      <div className="bg-blue-50 text-blue-700 w-fit px-4 py-2 font-medium text-lg rounded-xl flex items-center gap-2 uppercase">
                                        <HeartHandshake />
                                        Bonne route
                                        <HeartHandshake />
                                      </div>
